...
BOT_TOKEN = environ.get('BOT_TOKEN', "8735063781:AAEcNthLahyDBz5I2URdULmUDTm2RpE2Xxw")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003084490680'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003036018855 -1003086003339 -1002715303050 -1004167255440')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://banglajac13_db_user:ZGTKOUJTJloOFFQS@cluster0.wdbssln.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/request_gruop')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Mosharrafroy') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/jacpotfilmm')
...
LANGUAGES = ["bangla", "bengali", "ben", "tamil", "tam" ,"english", "eng", "hindi", "hin", "telugu", "tel", "kannada", "kan"]
